...
const biomeWeights: Record<Biome, number[]> = {
 ...
 outland:[0,0,0,0,0,0,0,0,0,34,34,18,0,0,0,0,0,0,0],
...
const oreQuota=(id:string)=>oreQuotaOverrides[id]??rarityQuota[ores.find(o=>o.id===id)?.rarity||"Common"];
