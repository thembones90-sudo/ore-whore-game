...
const migrate=(old:any):Save=>{
  ...
  const provisional={...blank,...safeOld,combos,ores:oreCounts,oreResources,mineralResources,processedResources,ownedTools,equippedTool,toolTier,toolSkinId,unlocks,first,minerals:mineralCounts,trueArtifacts,activeTrueEncounter:validEncounter,forbiddenTunnel,pendingArtifactModifier,settings:{...defaultSettings,...old.settings},schema:15} as Save;
