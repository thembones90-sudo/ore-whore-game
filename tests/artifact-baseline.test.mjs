...
test("every technology tier owns the canonical Artifact probability",()=>assert.deepEqual(forgedItems.map(t=>t.trueArtifactChance),[.0005,.0006,.0008,.001,.0015,.002,.003,.004,.005,.0075,.01]));
